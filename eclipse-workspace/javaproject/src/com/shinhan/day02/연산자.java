...
public class 연산자 {
	...
	private static void method8() {
		...
		System.out.println(s1.equals(s2)); //값이 같은지 비교
		System.out.println(System.identityHashCode(s1));
		System.out.println(System.identityHashCode(s2));		
	}

	private static void method7() {
		String s1 = "Java"; // string은 고정문자열이다. 값을 바꾸면 새로운 주소에 객체가 생성됨. 주소 비교라서...
		String s2 = "Java";
		// string에 literal을 직접 입력하면 컴파일시 만들어짐, 이미 있는 문자열은 다시 생성하지 않고 존재하는 주소를 사용함
	...
	private static void method6() {
		...
		System.out.println(result2); // NaN 이 나옴
		sc.close();
	}
