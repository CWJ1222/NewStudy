...
public class TypeTrans {
	...
	private static void typeTest7() {
		String score = "99";
		/*
		 * 기본형 타입은 data를 저장, 정수 실수 타입은 연산가능, 비교가능 wrapper class는 기본형 + 기능추가 byte => Byte
		 * short => Short char => Character ** int => Integer ** long => Long float =>
		...
		System.out.println(f+10); //기본이 소수점 밑에 6자

	}

	/*
	 * private static void typeTest6() { int a = 10; int b = 3;
	 * 
	 * System.out.println("더하기 " + (a + b)); System.out.println("뻬기 " + (a - b));
	 * System.out.println("곱하기 " + a * b); System.out.println("나누기 " + a / b);
	 * System.out.println("나머지 " + a % b); System.out.println("결과" + (double) a /
	 * b);
	 * 
	 * }
	 */
